---
name: architect
description: "Use only when explicitly invoked or routed by another pstack skill. Sketch types, signatures, and module structure before code, then stay in the loop while implementation fills in. Use for /architect, 'architect this', 'design this', or non-trivial work where jumping to code would lock in the wrong shape."
---
...
Use the current host model by default. Override only when a valid user or host model policy requires it.
