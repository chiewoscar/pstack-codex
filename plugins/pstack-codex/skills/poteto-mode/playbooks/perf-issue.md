...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. When permitted and useful, delegate implementation to a subagent using the current host model; review the diff. Capture a post-fix trace.
